...
const SocialIcons: React.FC = () => {
    return (
        <div className="flex dark:text-white space-x-4">
            <a href="https://github.com/assadounto" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-blue-500 transform transition-transform duration-300 hover:scale-110">
                <RiGithubLine size={24} />
            </a>
            <a href="http://linkedin.com/in/rich-adukyere" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-blue-500 transform transition-transform duration-300 hover:scale-110">
